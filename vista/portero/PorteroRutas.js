...
router.put('/actualizar/:id', ActualizarInformacionPorteroControlador.actualizarInformacion);
...
router.delete('/invitado/eliminar/:id', EliminarInvitadoControlador.eliminarInvitado);
